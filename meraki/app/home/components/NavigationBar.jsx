    ...
    <header className='sticky top-0 w-full left-0 flex items-center justify-between p-4 border-b border-solid border-white bg-white'>
      <nav className='flex justify-between items-center w-[90%] max-container h-12'>
        ...
        <div className='flex items-center gap-6'>
          ...
          : (
            <button
              className='hidden items-center xl:inline-flex bg-[#2B2B2B] text-white px-5 py-2 w-40 h-10 rounded-full duration-100 sm:hover:bg-[#8b8b8b] sm:hover:text-black active:bg-[#8b8b8b] active:text-black'
              onClick={() => signOut()}>
            ...
            <div className='flex-col py-4'>
              <ul className='items-center uppercase'> 
                ...
                : (
                  <li className='py-2 w-40'>
                    <button
                      className='flex items-center bg-[#2B2B2B] text-white px-5 py-2 w-40 h-10 rounded-full duration-100 sm:hover:bg-[#8b8b8b] sm:hover:text-black active:bg-[#8b8b8b] active:text-black text-sm'
                      onClick={() => signOut()}>
                        <span className='text-center w-full text-sm'>CERRAR SESION</span>
                    </button>
                  </li>
